...
const ChatBox = () => {
  ...
  const [messages, setMessages] = useState([
    { id: 1, text: "Hello! I'm SafeRoute Assistant. How can I help you in Tamil Nadu today?", sender: 'ai' }
  ]);
            ...
            <div className="p-4 bg-primary text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/70">System: Tamil Nadu Engine v1.0</p>
                </div>
              </div>
